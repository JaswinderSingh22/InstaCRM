  ...
  return (
    <div className="min-h-dvh bg-[#F4F5FA] text-neutral-900">
      <header className="border-b border-neutral-200/80 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-4xl flex-col gap-4 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          ...
          <nav className="flex flex-wrap items-center gap-1 sm:justify-end">
            ...
            <Link
              href="/login"
              className="ml-auto rounded-lg bg-gradient-to-r from-[#4F46E5] to-indigo-600 px-3 py-1.5 text-sm font-semibold text-white shadow-sm hover:from-[#4338ca] hover:to-indigo-600 sm:ml-1"
            >
              Log in
            </Link>
          </nav>
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:px-6 sm:py-14">
        <div className="rounded-2xl border border-neutral-200/80 bg-white p-5 shadow-sm ring-1 ring-neutral-200/40 sm:p-10">
          <h1 className="font-serif text-2xl font-bold tracking-tight text-neutral-900 sm:text-3xl">{title}</h1>
